...
class AuthFirebaseService implements AuthService {
  ...
  static final _userStream = Stream<PromoUser?>.multi((controller) async {
    final authChanges = FirebaseAuth.instance.authStateChanges();
    await for (final user in authChanges) {
      _currentUser = user == null ? null : _topromocoesUser(user);
  ...
  Future<void> signup(
    ...
    await _savepromocoesUser(_topromocoesUser(credential.user!/*, imageURL*/));
  }
